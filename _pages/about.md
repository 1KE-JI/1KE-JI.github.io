...
My research centers on **self-improving and trustworthy LLM agents** — building agents that can autonomously evolve their reasoning capabilities and remain reliable in complex real-world deployments. Concretely, I work on: (1) agentic reasoning and efficient inference-time adaptation; (2) LLM self-improvement without human supervision; and (3) trustworthy evaluation of agents in real-world tasks.
...
<small>\* denotes co-first authors, † denotes corresponding author/main advisor</small>
...
*NeurIPS 2025* <span style="color:#e74c3c">(Spotlight)</span>
